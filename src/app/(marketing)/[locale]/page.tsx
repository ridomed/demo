import {
  ...
  Technologies,
  FloatingWhatsApp,
} from "@/components/marketing/trial-and-technology";
...
export default async function MarketingPage({ params }: Props) {
  ...
  const brand = (
    <>
      <Image
        src={marketingBrand.icon}
        alt={marketingBrand.shortName}
        width={40}
        height={40}
        sizes="88px"
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(
            marketingStructuredData(locale, appName, copy),
          ).replace(/</g, "\\u003c"),
        }}
      />
      ...
      <main id="main-content" tabIndex={-1}>
        ...
        {getDemoCredentials() && (
          <div className={styles.container}>
            <DemoCredentials locale={locale} wide />
          </div>
        )}
        <div className={styles.container}>
          <LanguageSupport {...props} />
        </div>
